...
variable "growth_factor" {
  description = "Deployment growth factor."
  type        = number
  default     = 100
}
variable "replicate_to" {
  description = "Deployment strategy replication destination."
  type        = string
  default     = "NONE"
}
variable "description" {
  ...
  type        = string
  default     = "Example all-at-once deployment strategy."
}
...
variable "growth_type" {
  description = "Deployment growth type."
  type        = string
  default     = "LINEAR"
}
